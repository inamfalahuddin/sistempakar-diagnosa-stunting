<div id="layoutSidenav_content">
    <main>
        <div class="container-fluid px-4">
            <div class="row my-4">
                <div class="col">
                    <h3 class="text-capitalize">Data Gejala</h3>
                </div>
            </div>
            ...
            <div class="card my-4">
                ...
                <div class="card-body">
                    <table id="datatablesSimple">
                        ...
                        <tbody>
                            <?php foreach ($data_gejala as $item) : ?>
                                <tr>
                                    ...
                                    <td>
                                        <div class="d-flex justify-content-end align-items-center gap-2">
                                            <button type="button" class="btn btn-info btn-sm" data-bs-toggle="modal" data-bs-target="#editModal" onclick="loadDataForEdit('<?= $item['kode_gejala'] ?>')">
                                                Edit
                                            </button>
                                            <button class="btn btn-danger btn-sm" onclick="hapusGejala('<?= $item['kode_gejala'] ?>')">Hapus</button>
                                        </div>
                                    </td>
                                </tr>
                            <?php endforeach ?>
            ...
            if (xhr.readyState === XMLHttpRequest.DONE) {
                if (xhr.status === 200) {
                    ...
                    container.insertAdjacentHTML('beforeend', `
                        <input type="hidden" name="kode_gejala" class="form-control" id="kodeGejala" value="${data.kode_gejala}">
